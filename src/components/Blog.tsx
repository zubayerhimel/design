    ...
    <section className="py-20 bg-white dark:bg-neutral-900" id="blog">
      <div className="container mx-auto px-4">
        <div className="text-center mb-20">
          ...
          <h2 className={cn("text-4xl md:text-5xl font-medium mb-20 text-center text-neutral-900 dark:text-white mt-2", bonaNova.className)}>Latest Articles</h2>
        </div>
          ...
          {posts.map((post) => (
            <article
              ...
              <div className="space-y-4">
                ...
                <h3 className="text-xl font-semibold group-hover:text-rose-500 dark:group-hover:text-rose-400 transition-colors">{post.title}</h3>
